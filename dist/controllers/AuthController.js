...
exports.resetPassword = exports.forgotPassword = exports.protectAndRestrictTo = exports.login = exports.signUp = void 0;
...
const protectAndRestrictTo = (...roles) => {
    return async (req, res, next) => {
        try {
            ...
            const currentEmployee = await employeeModel_1.default.findById(decoded.employeeId);
            if (!currentEmployee) {
...
exports.protectAndRestrictTo = protectAndRestrictTo;
